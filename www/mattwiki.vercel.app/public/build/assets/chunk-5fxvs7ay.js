  ...
  return /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
    ...
    children: [
      /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
        className: "fixed inset-0 -z-10 bg-gradient-to-br from-[#0f0c29] via-[#302b63] to-[#24243e]"
      }, undefined, false, undefined, this),
      /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
        className: "pointer-events-none fixed inset-0 -z-10 overflow-hidden",
        children: [
          /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
            className: "absolute -top-40 -right-40 h-96 w-96 rounded-full bg-indigo-600/20 blur-[120px]"
          }, undefined, false, undefined, this),
          /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
            className: "absolute -bottom-40 -left-40 h-96 w-96 rounded-full bg-violet-600/20 blur-[120px]"
          }, undefined, false, undefined, this),
          /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
            className: "absolute top-1/2 left-1/2 h-64 w-64 -translate-x-1/2 -translate-y-1/2 rounded-full bg-indigo-500/10 blur-[100px]"
          }, undefined, false, undefined, this)
        ]
      }, undefined, true, undefined, this),
      flash?.success && /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
        className: "fixed top-4 right-4 z-50 glass rounded-xl px-5 py-3 text-sm text-emerald-300 border-emerald-500/30",
        children: flash.success
      }, undefined, false, undefined, this),
      flash?.error && /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
        className: "fixed top-4 right-4 z-50 glass rounded-xl px-5 py-3 text-sm text-rose-300 border-rose-500/30",
...
var HugeiconsIcon = import_react2.forwardRef(({ color = "currentColor", size = 24, strokeWidth, absoluteStrokeWidth = false, className = "", altIcon, showAlt = false, icon, primaryColor, secondaryColor, disableSecondaryOpacity = false, ...rest }, ref) => {
  ...
  const svgChildren = [...currentIcon].sort(([, a], [, b]) => {
    ...
    return import_react2.createElement(tag, {
      ...attrs,
      ...strokeProps,
      ...fillProps,
      opacity: pathOpacity,
  ...
  return import_react2.createElement("svg", elementProps, svgChildren);
});
HugeiconsIcon.displayName = "HugeiconsIcon";
// node_modules/@hugeicons/core-free-icons/dist/esm/Add01Icon.js
var Add01Icon = [
...
// node_modules/@hugeicons/core-free-icons/dist/esm/BookOpen01Icon.js
var BookOpen01Icon = [
...
// node_modules/@hugeicons/core-free-icons/dist/esm/Calendar01Icon.js
var Calendar01Icon = [
  ...
  ["path", { d: "M10 18.5002L9.99999 13.8474C9.99999 13.6557 9.86325 13.5002 9.69458 13.5002H9M14 18.4983L15.4855 13.8923C15.4951 13.8626 15.5 13.8315 15.5 13.8002C15.5 13.6346 15.3657 13.5002 15.2 13.5002L13 13.5", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "3" }]
];
...
// node_modules/@hugeicons/core-free-icons/dist/esm/Delete01Icon.js
var Delete01Icon = [
...
// node_modules/@hugeicons/core-free-icons/dist/esm/Edit01Icon.js
var Edit01Icon = [
  ...
  ["path", { d: "M6 15H3.75C2.7835 15 2 15.7835 2 16.75C2 17.7165 2.7835 18.5 3.75 18.5H13.25C14.2165 18.5 15 19.2835 15 20.25C15 21.2165 14.2165 22 13.25 22H11", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "1" }]
];
...
// node_modules/@hugeicons/core-free-icons/dist/esm/LockPasswordIcon.js
var LockPasswordIcon = [
  ...
  ["path", { d: "M7.5 9V6.5C7.5 4.01472 9.51472 2 12 2C14.4853 2 16.5 4.01472 16.5 6.5V9", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "1" }],
  ["path", { d: "M16 15.49V15.5", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", key: "2" }],
  ["path", { d: "M12 15.49V15.5", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", key: "3" }],
  ["path", { d: "M8 15.49V15.5", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", key: "4" }]
];

// node_modules/@hugeicons/core-free-icons/dist/esm/Login01Icon.js
var Login01Icon = [
...
// node_modules/@hugeicons/core-free-icons/dist/esm/Mail01Icon.js
var Mail01Icon = [
...
// node_modules/@hugeicons/core-free-icons/dist/esm/ShieldUserIcon.js
var ShieldUserIcon = [
  ...
  ["path", { d: "M8.5 14.4984C8.5 12.5654 10.067 10.9984 12 10.9984C13.933 10.9984 15.5 12.5654 15.5 14.4984M14 9C14 10.1046 13.1046 11 12 11C10.8954 11 10 10.1046 10 9C10 7.89543 10.8954 7 12 7C13.1046 7 14 7.89543 14 9Z", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "1" }]
];

// node_modules/@hugeicons/core-free-icons/dist/esm/StarOffIcon.js
var StarOffIcon = [
  ["path", { d: "M18.5038 14.5L21.1477 11.8925C22.616 10.4206 22.1366 8.92853 20.099 8.58575L16.9128 8.05143C16.3734 7.9607 15.7342 7.48687 15.4945 6.99288L13.7366 3.44418C12.7877 1.51861 11.2296 1.51861 10.2707 3.44418L9.5 5", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
...
// node_modules/@hugeicons/core-free-icons/dist/esm/User02Icon.js
var User02Icon = [
  ["path", { d: "M18.5 20V17.9704C18.5 16.7281 17.9407 15.5099 16.8103 14.9946C15.4315 14.3661 13.7779 14 12 14C10.2221 14 8.5685 14.3661 7.18968 14.9946C6.05927 15.5099 5.5 16.7281 5.5 17.9704V20", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
  ["circle", { cx: "12", cy: "7.5", r: "3.5", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "1" }]
];
...
// node_modules/@hugeicons/core-free-icons/dist/esm/UserCircleIcon.js
var UserCircleIcon = [
  ["path", { d: "M15 9C15 7.34315 13.6569 6 12 6C10.3431 6 9 7.34315 9 9C9 10.6569 10.3431 12 12 12C13.6569 12 15 10.6569 15 9Z", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
  ["path", { d: "M22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22C17.5228 22 22 17.5228 22 12Z", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "1" }],
  ["path", { d: "M17 17C17 14.2386 14.7614 12 12 12C9.23858 12 7 14.2386 7 17", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "2" }]
];
...
// node_modules/@hugeicons/core-free-icons/dist/esm/CheckmarkCircle01Icon.js
var CheckmarkCircle01Icon = [
  ...
  ["path", { d: "M8 12.75C8 12.75 9.6 13.6625 10.4 15C10.4 15 12.8 9.75 16 8", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "1" }]
];
// node_modules/@hugeicons/core-free-icons/dist/esm/CopyLinkIcon.js
var CopyLinkIcon = [
...
// node_modules/@hugeicons/core-free-icons/dist/esm/Facebook01Icon.js
var Facebook01Icon = [
  ["path", { d: "M2.5 12C2.5 7.52166 2.5 5.28249 3.89124 3.89124C5.28249 2.5 7.52166 2.5 12 2.5C16.4783 2.5 18.7175 2.5 20.1088 3.89124C21.5 5.28249 21.5 7.52166 21.5 12C21.5 16.4783 21.5 18.7175 20.1088 20.1088C18.7175 21.5 16.4783 21.5 12 21.5C7.52166 21.5 5.28249 21.5 3.89124 20.1088C2.5 18.7175 2.5 16.4783 2.5 12Z", stroke: "currentColor", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
  ["path", { d: "M16.9265 8.02637H13.9816C12.9378 8.02637 12.0894 8.86847 12.0817 9.91229L11.9964 21.4268M10.082 14.0017H14.8847", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "1" }]
];
// node_modules/@hugeicons/core-free-icons/dist/esm/Home01Icon.js
var Home01Icon = [
...
var Linkedin01Icon = [
  ...
  ["path", { d: "M7.00801 7L6.99902 7", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", key: "2" }],
  ["path", { d: "M2.5 12C2.5 7.52166 2.5 5.28249 3.89124 3.89124C5.28249 2.5 7.52166 2.5 12 2.5C16.4783 2.5 18.7175 2.5 20.1088 3.89124C21.5 5.28249 21.5 7.52166 21.5 12C21.5 16.4783 21.5 18.7175 20.1088 20.1088C18.7175 21.5 16.4783 21.5 12 21.5C7.52166 21.5 5.28249 21.5 3.89124 20.1088C2.5 18.7175 2.5 16.4783 2.5 12Z", stroke: "currentColor", strokeLinejoin: "round", strokeWidth: "1.5", key: "3" }]
];
// node_modules/@hugeicons/core-free-icons/dist/esm/Logout01Icon.js
var Logout01Icon = [
...
// node_modules/@hugeicons/core-free-icons/dist/esm/MastodonIcon.js
var MastodonIcon = [
  ["path", { d: "M17 13.5V8C17 6.61929 15.8807 5.5 14.5 5.5C13.1193 5.5 12 6.61929 12 8M12 8V11.5M12 8C12 6.61929 10.8807 5.5 9.5 5.5C8.11929 5.5 7 6.61929 7 8V13.5", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", key: "0" }],
...
// node_modules/@hugeicons/core-free-icons/dist/esm/Menu01Icon.js
var Menu01Icon = [
...
// node_modules/@hugeicons/core-free-icons/dist/esm/RedditIcon.js
var RedditIcon = [
  ["ellipse", { cx: "12", cy: "15.5", rx: "9", ry: "6.5", stroke: "currentColor", strokeWidth: "1.5", key: "0" }],
...
export { AppLayout, HugeiconsIcon, Add01Icon, ArrowRight01Icon, BookOpen01Icon, Calendar01Icon, Cancel01Icon, CheckmarkCircle01Icon, Clock01Icon, CopyLinkIcon, Delete01Icon, Edit01Icon, Edit02Icon, Facebook01Icon, Folder01Icon, Home01Icon, Linkedin01Icon, LockPasswordIcon, Login01Icon, Logout01Icon, Mail01Icon, MastodonIcon, Menu01Icon, NewTwitterIcon, RedditIcon, Search01Icon, Settings01Icon, ShieldUserIcon, StarOffIcon, StarIcon, User02Icon, UserAdd01Icon, UserCircleIcon };

//# debugId=78102A19801B189364756E2164756E21
//# sourceMappingURL=chunk-5fxvs7ay.js.map
