...
// resources/js/pages/Wiki/Show.tsx
var import_react9 = __toESM(require_react(), 1);

// resources/js/components/wiki/wiki-sidebar.tsx
var jsx_dev_runtime = __toESM(require_jsx_dev_runtime(), 1);
function WikiSidebar({ currentSlug, categories, readSlugs = new Set }) {
  const totalArticles = categories.reduce((sum, c) => sum + c.count, 0);
  const totalRead = categories.reduce((sum, c) => sum + c.articles.filter((a) => readSlugs.has(a.slug)).length, 0);
  return /* @__PURE__ */ jsx_dev_runtime.jsxDEV("aside", {
    className: "hidden lg:block w-64 shrink-0 py-6",
    children: /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
      className: "sticky top-24 glass rounded-2xl p-4 space-y-1",
      children: [
        /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
          className: "flex items-center gap-2 px-2 pb-2 mb-1 border-b border-white/10",
          children: [
            ...
            totalArticles > 0 && /* @__PURE__ */ jsx_dev_runtime.jsxDEV("span", {
              className: "ml-auto text-xs text-white/35",
              children: [
                totalRead,
                "/",
                totalArticles
        ...
        totalArticles > 0 && /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
        ...
        categories.map((category) => /* @__PURE__ */ jsx_dev_runtime.jsxDEV(CategorySection, {
          category,
          currentSlug,
          readSlugs
        }, category.name, false, undefined, this))
      ]
    }, undefined, true, undefined, this)
  }, undefined, false, undefined, this);
}
    ...
    children: [
      ...
      category.articles.map((article) => {
        ...
        return /* @__PURE__ */ jsx_dev_runtime.jsxDEV(Link_default, {
          ...
          className: cn("flex items-center gap-2 rounded-xl px-3 py-2 text-sm transition-all duration-150 cursor-pointer", isActive ? "bg-indigo-500/20 text-indigo-200 border border-indigo-500/25" : "text-white/55 hover:text-white/85 hover:bg-white/6"),
          children: [
            isActive ? /* @__PURE__ */ jsx_dev_runtime.jsxDEV(HugeiconsIcon, {
              icon: ArrowRight01Icon,
              className: "size-3.5 text-indigo-400 shrink-0"
            }, undefined, false, undefined, this) : isRead ? /* @__PURE__ */ jsx_dev_runtime.jsxDEV(HugeiconsIcon, {
              icon: CheckmarkCircle01Icon,
              className: "size-3.5 text-emerald-400/80 shrink-0"
...
// resources/js/components/wiki/toc.tsx
var import_react3 = __toESM(require_react(), 1);
var jsx_dev_runtime2 = __toESM(require_jsx_dev_runtime(), 1);
function Toc({ entries }) {
  const [activeId, setActiveId] = import_react3.useState("");
  ...
  import_react3.useEffect(() => {
    ...
    observerRef.current = new IntersectionObserver((records) => {
  ...
  return /* @__PURE__ */ jsx_dev_runtime2.jsxDEV("aside", {
    className: "hidden xl:block w-56 shrink-0 py-6",
    children: /* @__PURE__ */ jsx_dev_runtime2.jsxDEV("div", {
      className: "sticky top-24 glass rounded-2xl p-4",
      children: [
        /* @__PURE__ */ jsx_dev_runtime2.jsxDEV("p", {
          className: "mb-3 text-xs font-semibold uppercase tracking-wider text-white/40 px-2",
        ...
        /* @__PURE__ */ jsx_dev_runtime2.jsxDEV("nav", {
          ...
          children: entries.map((entry) => {
            ...
            return /* @__PURE__ */ jsx_dev_runtime2.jsxDEV("a", {
              href: `#${entry.id}`,
              className: cn("block rounded-lg py-1.5 text-sm transition-colors duration-150 cursor-pointer", entry.level === 2 ? "px-2" : "px-4 text-xs", isActive ? "text-indigo-300 font-medium bg-indigo-500/15" : "text-white/50 hover:text-white/85"),
              children: [
                isActive && entry.level === 2 && /* @__PURE__ */ jsx_dev_runtime2.jsxDEV("span", {
                  className: "inline-block w-1 h-1 rounded-full bg-indigo-400 mr-1.5 mb-0.5"
                }, undefined, false, undefined, this),
                entry.text
              ]
...
function developmentCreate(filePath, jsxDEV3) {
  return create2;
  function create2(node, type, props, key) {
    const isStaticChildren = Array.isArray(props.children);
    const point3 = pointStart(node);
    return jsxDEV3(type, props, key, isStaticChildren, {
...
function footer(state) {
  ...
  while (++referenceIndex < state.footnoteOrder.length) {
    ...
    state.patch(definition2, listItem);
...
// resources/js/lib/wiki-markdown.ts
function extractToc(content3) {
...
`);
  ...
  for (const line of lines) {
    ...
    if (h2) {
      const text7 = h2[1].trim();
      entries.push({ id: slugify(text7), text: text7, level: 2 });
    } else if (h3) {
      const text7 = h3[1].trim();
      entries.push({ id: slugify(text7), text: text7, level: 3 });
    }
  }
  return entries;
}
function preprocessMarkdown(content3) {
  return content3.replace(/\\n/g, `
`).replace(/\r\n/g, `
`).trim();
}
function slugify(text7) {
  return text7.toLowerCase().replace(/[^\w\s-]/g, "").replace(/\s+/g, "-").replace(/-+/g, "-").trim();
}

// resources/js/components/wiki/markdown-renderer.tsx
var jsx_dev_runtime3 = __toESM(require_jsx_dev_runtime(), 1);
function MarkdownRenderer({ content: content3 }) {
  const toc = extractToc(content3);
  const headingIds = toc.reduce((acc, entry) => {
  ...
  return /* @__PURE__ */ jsx_dev_runtime3.jsxDEV("div", {
    ...
    children: /* @__PURE__ */ jsx_dev_runtime3.jsxDEV(Markdown, {
      ...
      components: {
        h1: ({ children }) => /* @__PURE__ */ jsx_dev_runtime3.jsxDEV("h1", {
          id: headingIds[String(children)] ?? undefined,
          children
        }, undefined, false, undefined, this),
        h2: ({ children }) => /* @__PURE__ */ jsx_dev_runtime3.jsxDEV("h2", {
          id: headingIds[String(children)] ?? undefined,
          children
        }, undefined, false, undefined, this),
        h3: ({ children }) => /* @__PURE__ */ jsx_dev_runtime3.jsxDEV("h3", {
          id: headingIds[String(children)] ?? undefined,
          children
        }, undefined, false, undefined, this),
        a: ({ href, children }) => /* @__PURE__ */ jsx_dev_runtime3.jsxDEV("a", {
          href,
          target: href?.startsWith("http") ? "_blank" : undefined,
          rel: "noopener noreferrer",
          children
        }, undefined, false, undefined, this),
        pre: ({ children }) => /* @__PURE__ */ jsx_dev_runtime3.jsxDEV("pre", {
          children
        }, undefined, false, undefined, this),
...
function Breadcrumb({ className, children, ...props }) {
  return /* @__PURE__ */ jsx_dev_runtime4.jsxDEV("nav", {
...
function BreadcrumbList({ className, children, ...props }) {
  return /* @__PURE__ */ jsx_dev_runtime4.jsxDEV("ol", {
    className: cn("flex items-center gap-1.5 text-sm text-white/50", className),
    ...props,
    children
  }, undefined, false, undefined, this);
}
...
function BreadcrumbPage({ className, children, ...props }) {
  return /* @__PURE__ */ jsx_dev_runtime4.jsxDEV("span", {
    "aria-current": "page",
    className: cn("text-white/80 font-medium", className),
    ...props,
    children
  }, undefined, false, undefined, this);
}
function BreadcrumbSeparator({ className, ...props }) {
  return /* @__PURE__ */ jsx_dev_runtime4.jsxDEV("span", {
    "aria-hidden": true,
    className: cn("text-white/25 select-none", className),
    ...props,
    children: "/"
  }, undefined, false, undefined, this);
}
...
function TooltipTrigger({ children, render, className }) {
  const [visible, setVisible] = import_react5.useState(false);
  ...
  return /* @__PURE__ */ jsx_dev_runtime5.jsxDEV("span", {
    ...
    children: [
      import_react5.isValidElement(target) ? import_react5.cloneElement(target, {
        className: cn(target.props.className)
      }) : target,
      visible && /* @__PURE__ */ jsx_dev_runtime5.jsxDEV("div", {
...
function TooltipContent({ children, className, ...props }) {
  return /* @__PURE__ */ jsx_dev_runtime5.jsxDEV("div", {
    role: "tooltip",
    className: cn("whitespace-nowrap rounded-lg glass-strong px-3 py-1.5 text-xs text-white/90 shadow-xl", className),
    ...props,
    children
  }, undefined, false, undefined, this);
}

// resources/js/components/ui/tracing-beam.tsx
var jsx_dev_runtime6 = __toESM(require_jsx_dev_runtime(), 1);
function TracingBeam({ children, className, ...props }) {
  return /* @__PURE__ */ jsx_dev_runtime6.jsxDEV("div", {
    ...
    children: [
      /* @__PURE__ */ jsx_dev_runtime6.jsxDEV("div", {
        ...
        style: {
          background: "linear-gradient(to bottom, transparent 0%, rgba(99,102,241,0.5) 20%, rgba(139,92,246,0.4) 70%, transparent 100%)"
        }
      }, undefined, false, undefined, this),
      /* @__PURE__ */ jsx_dev_runtime6.jsxDEV("div", {
        "aria-hidden": true,
        ...
        children: [
          /* @__PURE__ */ jsx_dev_runtime6.jsxDEV("div", {
            className: "h-4 w-4 rounded-full border border-indigo-500/40 bg-indigo-500/20 backdrop-blur-sm"
          }, undefined, false, undefined, this),
          /* @__PURE__ */ jsx_dev_runtime6.jsxDEV("div", {
            className: "absolute inset-1 rounded-full bg-indigo-400/60"
          }, undefined, false, undefined, this)
        ]
      }, undefined, true, undefined, this),
      children
...
// resources/js/components/wiki/share-buttons.tsx
var import_react6 = __toESM(require_react(), 1);
var jsx_dev_runtime7 = __toESM(require_jsx_dev_runtime(), 1);
function ShareButtons({ title, slug }) {
  const [copied, setCopied] = import_react6.useState(false);
  const [showFediverse, setShowFediverse] = import_react6.useState(false);
  const [instance, setInstance] = import_react6.useState("");
  const inputRef = import_react6.useRef(null);
  ...
  function shareFediverse() {
    ...
    const text7 = encodeURIComponent(`${title} ${url}`);
    window.open(`https://${host}/share?text=${text7}`, "_blank", "noopener,noreferrer");
  ...
  return /* @__PURE__ */ jsx_dev_runtime7.jsxDEV("div", {
    ...
    children: [
      ...
      platforms.map(({ label, icon, href }) => /* @__PURE__ */ jsx_dev_runtime7.jsxDEV("a", {
        href,
        target: "_blank",
        rel: "noopener noreferrer",
      ...
      showFediverse ? /* @__PURE__ */ jsx_dev_runtime7.jsxDEV("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx_dev_runtime7.jsxDEV(Button, {
            ...
            onClick: shareFediverse,
            children: /* @__PURE__ */ jsx_dev_runtime7.jsxDEV(HugeiconsIcon, {
              icon: ArrowRight01Icon,
              strokeWidth: 2,
              className: "size-4"
            }, undefined, false, undefined, this)
...
// resources/js/lib/read-articles.ts
var import_react8 = __toESM(require_react(), 1);
var STORAGE_KEY = "mattwiki_read_articles";
...
function saveReadSlugs(slugs) {
  localStorage.setItem(STORAGE_KEY, JSON.stringify([...slugs]));
}
function useReadArticles() {
  const [readSlugs, setReadSlugs] = import_react8.useState(() => new Set);
  import_react8.useEffect(() => {
    setReadSlugs(loadReadSlugs());
  }, []);
  const markRead = import_react8.useCallback((slug) => {
    setReadSlugs((prev) => {
      if (prev.has(slug))
        return prev;
...
function WikiShow({ article, categories }) {
  const { auth } = usePage().props;
  const isAdmin = auth.user?.is_admin ?? false;
  const processed = import_react9.useMemo(() => preprocessMarkdown(article.content), [article.content]);
  const toc = import_react9.useMemo(() => extractToc(article.content), [article.content]);
  ...
  return /* @__PURE__ */ jsx_dev_runtime8.jsxDEV(AppLayout, {
    children: /* @__PURE__ */ jsx_dev_runtime8.jsxDEV("div", {
      className: "min-h-screen bg-background animate-in fade-in-0 duration-500",
      children: [
        /* @__PURE__ */ jsx_dev_runtime8.jsxDEV(WikiHeader, {}, undefined, false, undefined, this),
        /* @__PURE__ */ jsx_dev_runtime8.jsxDEV("div", {
          className: "mx-auto flex max-w-screen-xl gap-8 px-4",
          children: [
            /* @__PURE__ */ jsx_dev_runtime8.jsxDEV(WikiSidebar, {
            ...
            /* @__PURE__ */ jsx_dev_runtime8.jsxDEV("main", {
              ...
              children: [
                /* @__PURE__ */ jsx_dev_runtime8.jsxDEV(Breadcrumb, {
                  className: "mb-4",
                  children: /* @__PURE__ */ jsx_dev_runtime8.jsxDEV(BreadcrumbList, {
                    children: [
                      /* @__PURE__ */ jsx_dev_runtime8.jsxDEV(BreadcrumbItem, {
                        children: /* @__PURE__ */ jsx_dev_runtime8.jsxDEV(BreadcrumbLink, {
                          href: "/",
                          children: "Home"
                        }, undefined, false, undefined, this)
                      }, undefined, false, undefined, this),
                      /* @__PURE__ */ jsx_dev_runtime8.jsxDEV(BreadcrumbSeparator, {}, undefined, false, undefined, this),
                      /* @__PURE__ */ jsx_dev_runtime8.jsxDEV(BreadcrumbItem, {
                        children: /* @__PURE__ */ jsx_dev_runtime8.jsxDEV(BreadcrumbLink, {
                          href: "/categories",
                      ...
                      /* @__PURE__ */ jsx_dev_runtime8.jsxDEV(BreadcrumbSeparator, {}, undefined, false, undefined, this),
                      /* @__PURE__ */ jsx_dev_runtime8.jsxDEV(BreadcrumbItem, {
                        children: /* @__PURE__ */ jsx_dev_runtime8.jsxDEV(BreadcrumbPage, {
                          children: article.title
                        }, undefined, false, undefined, this)
                      }, undefined, false, undefined, this)
                    ]
                ...
                /* @__PURE__ */ jsx_dev_runtime8.jsxDEV("div", {
                  ...
                  children: [
                    /* @__PURE__ */ jsx_dev_runtime8.jsxDEV("div", {
                      ...
                      children: article.tags.map((tag) => /* @__PURE__ */ jsx_dev_runtime8.jsxDEV(Badge, {
                        variant: "secondary",
                        children: tag
                          ...
                          children: [
                            /* @__PURE__ */ jsx_dev_runtime8.jsxDEV(Avatar, {
                              ...
                              children: /* @__PURE__ */ jsx_dev_runtime8.jsxDEV(AvatarFallback, {
                                children: /* @__PURE__ */ jsx_dev_runtime8.jsxDEV(HugeiconsIcon, {
                                  icon: User02Icon,
                                  strokeWidth: 2,
                                  className: "size-3"
                                }, undefined, false, undefined, this)
                    ...
                    /* @__PURE__ */ jsx_dev_runtime8.jsxDEV("div", {
                      className: "mt-4",
                      children: /* @__PURE__ */ jsx_dev_runtime8.jsxDEV(ShareButtons, {
                        title: article.title,
                        slug: article.slug
                      }, undefined, false, undefined, this)
                    }, undefined, false, undefined, this)
                ...
                /* @__PURE__ */ jsx_dev_runtime8.jsxDEV(TracingBeam, {
                  className: "px-0",
                  children: [
                    /* @__PURE__ */ jsx_dev_runtime8.jsxDEV("article", {
                      children: /* @__PURE__ */ jsx_dev_runtime8.jsxDEV(MarkdownRenderer, {
                        content: processed
                      }, undefined, false, undefined, this)
                    }, undefined, false, undefined, this),
                    /* @__PURE__ */ jsx_dev_runtime8.jsxDEV(Separator, {
                    ...
                    /* @__PURE__ */ jsx_dev_runtime8.jsxDEV("div", {
                      ...
                      children: [
                        ...
                        isAdmin && /* @__PURE__ */ jsx_dev_runtime8.jsxDEV(Tooltip, {
                          children: [
                            /* @__PURE__ */ jsx_dev_runtime8.jsxDEV(TooltipTrigger, {
                              render: /* @__PURE__ */ jsx_dev_runtime8.jsxDEV(Link_default, {
                            ...
                            /* @__PURE__ */ jsx_dev_runtime8.jsxDEV(TooltipContent, {
            ...
            /* @__PURE__ */ jsx_dev_runtime8.jsxDEV(Toc, {
              entries: toc
            }, undefined, false, undefined, this)
          ]
        }, undefined, true, undefined, this)
...
//# debugId=22D3DCF544D1C17164756E2164756E21
//# sourceMappingURL=chunk-3dzcc2s5.js.map
