...
function CardContainer({ children, className, containerClassName }) {
  ...
  const [perspective, setPerspective] = import_react2.useState(1000);
  ...
  return /* @__PURE__ */ jsx_dev_runtime2.jsxDEV("div", {
    ...
    children: /* @__PURE__ */ jsx_dev_runtime2.jsxDEV("div", {
      className: cn("rounded-xl border bg-card text-card-foreground shadow-sm transition-shadow duration-200 hover:shadow-lg", className),
      children
    }, undefined, false, undefined, this)
  }, undefined, false, undefined, this);
}
...
function CardTitle({ children, className }) {
  return /* @__PURE__ */ jsx_dev_runtime2.jsxDEV("h3", {
    className: cn("text-2xl font-semibold leading-none tracking-tight", className),
    children
  }, undefined, false, undefined, this);
}
function CardDescription({ children, className }) {
  return /* @__PURE__ */ jsx_dev_runtime2.jsxDEV("p", {
...
function TableHeader({ className, ...props }) {
  return /* @__PURE__ */ jsx_dev_runtime3.jsxDEV("thead", {
...
function TableBody({ className, ...props }) {
  return /* @__PURE__ */ jsx_dev_runtime3.jsxDEV("tbody", {
...
function TableHead({ className, ...props }) {
  return /* @__PURE__ */ jsx_dev_runtime3.jsxDEV("th", {
...
function TableCell({ className, ...props }) {
  return /* @__PURE__ */ jsx_dev_runtime3.jsxDEV("td", {
...
var Sparkles = ({
  ...
  const [particles, setParticles] = import_react3.useState([]);
  ...
  return /* @__PURE__ */ jsx_dev_runtime4.jsxDEV("svg", {
    ...
    children: [
      /* @__PURE__ */ jsx_dev_runtime4.jsxDEV("defs", {
        children: /* @__PURE__ */ jsx_dev_runtime4.jsxDEV("radialGradient", {
          id: `${id}-gradient`,
          children: [
      ...
      particles.map((particle, idx) => /* @__PURE__ */ jsx_dev_runtime4.jsxDEV("circle", {
        cx: particle.x + "%",
        cy: particle.y + "%",
        r: particle.size,
        fill: particleColor,
...
var BackgroundBeams = ({ className, beamCount = 20 }) => {
  ...
  const beamsRef = import_react4.useRef([]);
  const animationFrameRef = import_react4.useRef(0);
  const initBeams = import_react4.useCallback(() => {
  ...
  return /* @__PURE__ */ jsx_dev_runtime5.jsxDEV("canvas", {
    ref: canvasRef,
    className: cn("absolute inset-0 h-full w-full", className),
    style: { zIndex: 0 }
  }, undefined, false, undefined, this);
...
"use client";
var LayoutGroupContext = import_react5.createContext({});
...
"use client";
var PresenceContext = /* @__PURE__ */ import_react8.createContext(null);
...
var velocityPerSecond = (velocity, frameDuration) => frameDuration ? velocity * (1000 / frameDuration) : 0;
...
var supportsScrollTimeline = /* @__PURE__ */ memoSupports(() => window.ScrollTimeline !== undefined, "scrollTimeline");
...
"use client";
var MotionConfigContext = import_react9.createContext({
...
class PopChildMeasure extends React2.Component {
...
function PopChild({ children, isPresent, anchorX, anchorY, root, pop }) {
  ...
  const size = import_react10.useRef({
    width: 0,
    height: 0,
    top: 0,
    left: 0,
  ...
  const { nonce } = import_react10.useContext(MotionConfigContext);
  const childRef = children.props?.ref ?? children?.ref;
  const composedRef = useComposedRefs(ref, childRef);
  import_react10.useInsertionEffect(() => {
...
var PresenceChild = ({ children, initial, isPresent, onExitComplete, custom, presenceAffectsLayout, mode, anchorX, anchorY, root }) => {
  ...
  const id2 = import_react11.useId();
  let isReusedContext = true;
  let context = import_react11.useMemo(() => {
...
function usePresence(subscribe = true) {
  const context = import_react12.useContext(PresenceContext);
  if (context === null)
    return [true, null];
  const { isPresent, onExitComplete, register } = context;
  const id2 = import_react12.useId();
  import_react12.useEffect(() => {
    if (subscribe) {
      return register(id2);
    }
  }, [subscribe]);
  const safeToRemove = import_react12.useCallback(() => subscribe && onExitComplete && onExitComplete(id2), [id2, onExitComplete, subscribe]);
...
function onlyElements(children) {
  ...
  import_react13.Children.forEach(children, (child) => {
    if (import_react13.isValidElement(child))
      filtered.push(child);
  });
  return filtered;
}
...
var AnimatePresence = ({ children, custom, initial = true, onExitComplete, presenceAffectsLayout = true, mode = "sync", propagate = false, anchorX = "left", anchorY = "top", root }) => {
  ...
  const presentChildren = import_react14.useMemo(() => onlyElements(children), [children]);
  const presentKeys = propagate && !isParentPresent ? [] : presentChildren.map(getChildKey);
  const isInitialRender = import_react14.useRef(true);
  const pendingPresentChildren = import_react14.useRef(presentChildren);
  const exitComplete = useConstant(() => new Map);
  const exitingComponents = import_react14.useRef(new Set);
  const [diffedChildren, setDiffedChildren] = import_react14.useState(presentChildren);
  const [renderedChildren, setRenderedChildren] = import_react14.useState(presentChildren);
  ...
  const { forceRender } = import_react14.useContext(LayoutGroupContext);
...
var createDomVisualElement = (Component2, options) => {
  ...
  return isSVG ? new SVGVisualElement(options) : new HTMLVisualElement(options, {
    allowProjection: Component2 !== import_react15.Fragment
  });
};
...
"use client";
var LazyContext = import_react16.createContext({ strict: false });

// node_modules/framer-motion/dist/es/context/MotionContext/index.mjs
var import_react17 = __toESM(require_react(), 1);
"use client";
var MotionContext = /* @__PURE__ */ import_react17.createContext({});
...
function useCreateMotionContext(props) {
  const { initial, animate } = getCurrentTreeVariants(props, import_react18.useContext(MotionContext));
  return import_react18.useMemo(() => ({ initial, animate }), [variantLabelsAsDependency(initial), variantLabelsAsDependency(animate)]);
}
...
function useSVGProps(props, visualState, _isStatic, Component2) {
  const visualProps = import_react20.useMemo(() => {
...
function useRender(Component2, props, ref, { latestValues }, isStatic, forwardMotionProps = false, isSVG) {
  ...
  const renderedChildren = import_react21.useMemo(() => isMotionValue(children) ? children.get() : children, [children]);
  return import_react21.createElement(Component2, {
    ...elementProps,
...
var makeUseVisualState = (config) => (props, isStatic) => {
  const context = import_react22.useContext(MotionContext);
...
function useMotionRef(visualState, visualElement, externalRef) {
  const externalRefContainer = import_react23.useRef(externalRef);
  import_react23.useInsertionEffect(() => {
    externalRefContainer.current = externalRef;
  });
  const refCleanup = import_react23.useRef(null);
  return import_react23.useCallback((instance) => {
    if (instance) {
...
"use client";
var SwitchLayoutGroupContext = import_react24.createContext({});
...
function useVisualElement(Component2, visualState, props, createVisualElement, ProjectionNodeConstructor, isSVG) {
  const { visualElement: parent } = import_react25.useContext(MotionContext);
  const lazyContext = import_react25.useContext(LazyContext);
  const presenceContext = import_react25.useContext(PresenceContext);
  const motionConfig = import_react25.useContext(MotionConfigContext);
  const reducedMotionConfig = motionConfig.reducedMotion;
  const skipAnimations = motionConfig.skipAnimations;
  const visualElementRef = import_react25.useRef(null);
  const hasMountedOnce = import_react25.useRef(false);
  ...
  const initialLayoutGroupConfig = import_react25.useContext(SwitchLayoutGroupContext);
  ...
  const isMounted = import_react25.useRef(false);
  import_react25.useInsertionEffect(() => {
    if (visualElement && isMounted.current) {
      visualElement.update(props, presenceContext);
    }
  });
  const optimisedAppearId = props[optimizedAppearDataAttribute];
  const wantsHandoff = import_react25.useRef(Boolean(optimisedAppearId) && typeof window !== "undefined" && !window.MotionHandoffIsComplete?.(optimisedAppearId) && window.MotionHasOptimisedAnimation?.(optimisedAppearId));
  useIsomorphicLayoutEffect(() => {
...
function createMotionComponent(Component2, { forwardMotionProps = false, type } = {}, preloadedFeatures, createVisualElement) {
  ...
  function MotionDOMComponent(props, externalRef) {
    ...
    const configAndProps = {
      ...import_react26.useContext(MotionConfigContext),
      ...props,
  ...
  const ForwardRefMotionComponent = import_react26.forwardRef(MotionDOMComponent);
  ForwardRefMotionComponent[motionComponentSymbol] = Component2;
  return ForwardRefMotionComponent;
}
function useLayoutId({ layoutId }) {
  const layoutGroupId = import_react26.useContext(LayoutGroupContext).id;
  return layoutGroupId && layoutId !== undefined ? layoutGroupId + "-" + layoutId : layoutId;
}
function useStrictMode(configAndProps, preloadedFeatures) {
  const isStrict = import_react26.useContext(LazyContext).strict;
...
class MeasureLayoutWithContext extends import_react27.Component {
  componentDidMount() {
...
function MeasureLayout(props) {
  ...
  const layoutGroup = import_react27.useContext(LayoutGroupContext);
  return import_jsx_runtime5.jsx(MeasureLayoutWithContext, { ...props, layoutGroup, switchLayoutGroup: import_react27.useContext(SwitchLayoutGroupContext), isPresent, safeToRemove });
}
...
var FlipWords = ({
  ...
  const [currentWord, setCurrentWord] = import_react28.useState(words[0]);
  const [isAnimating, setIsAnimating] = import_react28.useState(false);
  const startAnimation = import_react28.useCallback(() => {
  ...
  return /* @__PURE__ */ jsx_dev_runtime6.jsxDEV(AnimatePresence, {
    children: /* @__PURE__ */ jsx_dev_runtime6.jsxDEV(motion.span, {
    ...
    }, currentWord, false, undefined, this)
  }, undefined, false, undefined, this);
};
...
function ContributeButtons() {
  ...
  return /* @__PURE__ */ jsx_dev_runtime7.jsxDEV("div", {
    ...
    children: [
      ...
      !loggedIn && /* @__PURE__ */ jsx_dev_runtime7.jsxDEV(Link_default, {
        href: "/signup",
        children: /* @__PURE__ */ jsx_dev_runtime7.jsxDEV(Button, {
          variant: "outline",
          size: "sm",
...
function Home({ featured, recentChanges, categories }) {
  ...
  return /* @__PURE__ */ jsx_dev_runtime8.jsxDEV(AppLayout, {
    children: /* @__PURE__ */ jsx_dev_runtime8.jsxDEV("div", {
      ...
      children: [
        /* @__PURE__ */ jsx_dev_runtime8.jsxDEV(WikiHeader, {}, undefined, false, undefined, this),
        /* @__PURE__ */ jsx_dev_runtime8.jsxDEV("section", {
          className: "relative overflow-hidden border-b bg-muted/30 py-20",
          children: [
            /* @__PURE__ */ jsx_dev_runtime8.jsxDEV(Sparkles, {
              id: "hero-sparkles",
              particleDensity: 60,
              minSize: 0.6,
              maxSize: 1.2,
            ...
            /* @__PURE__ */ jsx_dev_runtime8.jsxDEV(BackgroundBeams, {
              beamCount: 15
            }, undefined, false, undefined, this),
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsx_dev_runtime8.jsxDEV("p", {
                    ...
                    children: [
                      "Your hub for",
                      " ",
                      /* @__PURE__ */ jsx_dev_runtime8.jsxDEV(FlipWords, {
                        words: FLIP_WORDS,
                  ...
                  /* @__PURE__ */ jsx_dev_runtime8.jsxDEV("form", {
                    ...
                    children: [
                      /* @__PURE__ */ jsx_dev_runtime8.jsxDEV(HugeiconsIcon, {
                        icon: Search01Icon,
                        strokeWidth: 2,
              ...
              children: [
                /* @__PURE__ */ jsx_dev_runtime8.jsxDEV("div", {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsx_dev_runtime8.jsxDEV(Link_default, {
                      href: "/articles",
                ...
                /* @__PURE__ */ jsx_dev_runtime8.jsxDEV("div", {
                  ...
                  children: featured === undefined ? Array.from({ length: 3 }).map((_, i) => /* @__PURE__ */ jsx_dev_runtime8.jsxDEV(CardContainer, {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsx_dev_runtime8.jsxDEV(CardFooter, {
                        className: "gap-3",
                        children: [
                          /* @__PURE__ */ jsx_dev_runtime8.jsxDEV("div", {
                  ...
                  }, i, true, undefined, this)) : featured.map((article, i) => /* @__PURE__ */ jsx_dev_runtime8.jsxDEV(Link_default, {
                    href: `/wiki/${article.slug}`,
                    className: "group block animate-in fade-in-0 slide-in-from-bottom-4 duration-500 fill-mode-both",
                    style: { animationDelay: `${i * 80}ms` },
                    children: /* @__PURE__ */ jsx_dev_runtime8.jsxDEV(CardContainer, {
                      ...
                      children: [
                        /* @__PURE__ */ jsx_dev_runtime8.jsxDEV(CardHeader, {
                          children: [
                            /* @__PURE__ */ jsx_dev_runtime8.jsxDEV("div", {
                              className: "mb-1",
                              children: /* @__PURE__ */ jsx_dev_runtime8.jsxDEV(Badge, {
                                variant: "secondary",
                            ...
                            /* @__PURE__ */ jsx_dev_runtime8.jsxDEV(CardDescription, {
                        ...
                        /* @__PURE__ */ jsx_dev_runtime8.jsxDEV(CardFooter, {
                          ...
                          children: [
                            ...
                            /* @__PURE__ */ jsx_dev_runtime8.jsxDEV(Separator, {
              ...
              children: [
                /* @__PURE__ */ jsx_dev_runtime8.jsxDEV("section", {
                  children: [
                    ...
                    /* @__PURE__ */ jsx_dev_runtime8.jsxDEV(CardContainer, {
                      children: /* @__PURE__ */ jsx_dev_runtime8.jsxDEV(CardContent, {
                        className: "p-0",
                        children: /* @__PURE__ */ jsx_dev_runtime8.jsxDEV(Table, {
                          children: [
                            /* @__PURE__ */ jsx_dev_runtime8.jsxDEV(TableHeader, {
                              children: /* @__PURE__ */ jsx_dev_runtime8.jsxDEV(TableRow, {
                                children: [
                                  /* @__PURE__ */ jsx_dev_runtime8.jsxDEV(TableHead, {
                                    children: "Article"
                                  }, undefined, false, undefined, this),
                                  /* @__PURE__ */ jsx_dev_runtime8.jsxDEV(TableHead, {
                            ...
                            /* @__PURE__ */ jsx_dev_runtime8.jsxDEV(TableBody, {
                              children: recentChanges === undefined ? Array.from({ length: 5 }).map((_, i) => /* @__PURE__ */ jsx_dev_runtime8.jsxDEV(TableRow, {
                                className: "animate-pulse",
                                children: [
                                  /* @__PURE__ */ jsx_dev_runtime8.jsxDEV(TableCell, {
                                    children: /* @__PURE__ */ jsx_dev_runtime8.jsxDEV("div", {
                              ...
                              }, i, true, undefined, this)) : recentChanges.map((change, i) => /* @__PURE__ */ jsx_dev_runtime8.jsxDEV(TableRow, {
                                ...
                                children: [
                                  ...
                                  /* @__PURE__ */ jsx_dev_runtime8.jsxDEV(TableCell, {
                                    ...
                                    children: /* @__PURE__ */ jsx_dev_runtime8.jsxDEV("div", {
                                      className: "flex items-center gap-2",
                                      children: [
                                        /* @__PURE__ */ jsx_dev_runtime8.jsxDEV(Avatar, {
                                          size: "sm",
                                          children: /* @__PURE__ */ jsx_dev_runtime8.jsxDEV(AvatarFallback, {
                                            className: "text-[10px]",
                ...
                /* @__PURE__ */ jsx_dev_runtime8.jsxDEV("section", {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsx_dev_runtime8.jsxDEV(CardContainer, {
                      children: /* @__PURE__ */ jsx_dev_runtime8.jsxDEV(CardContent, {
                        className: "flex flex-col gap-2",
                        children: categories === undefined ? Array.from({ length: 4 }).map((_, i) => /* @__PURE__ */ jsx_dev_runtime8.jsxDEV("div", {
                        ...
                        }, i, true, undefined, this)) : categories.map((cat, i) => /* @__PURE__ */ jsx_dev_runtime8.jsxDEV(Link_default, {
                          href: "/categories",
                    ...
                    /* @__PURE__ */ jsx_dev_runtime8.jsxDEV(CardContainer, {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsx_dev_runtime8.jsxDEV(CardContent, {
                          children: /* @__PURE__ */ jsx_dev_runtime8.jsxDEV(ContributeButtons, {}, undefined, false, undefined, this)
                        }, undefined, false, undefined, this)
                      ]
                    }, undefined, true, undefined, this)
                  ]
...
//# debugId=91ACE101F3C7980364756E2164756E21
//# sourceMappingURL=chunk-d0kzw03z.js.map
