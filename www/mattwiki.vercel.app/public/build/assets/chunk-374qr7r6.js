    ...
    children: /* @__PURE__ */ jsx_dev_runtime2.jsxDEV("div", {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx_dev_runtime2.jsxDEV("nav", {
          className: "space-y-0.5",
          children: entries.map((entry) => /* @__PURE__ */ jsx_dev_runtime2.jsxDEV("a", {
            href: `#${entry.id}`,
            className: cn("block rounded-lg py-1.5 text-sm transition-colors duration-150 cursor-pointer", "text-white/50 hover:text-white/85", entry.level === 2 ? "px-2" : "px-4 text-xs"),
            children: entry.text
...
function TooltipTrigger({ children, render, className }) {
  ...
  return /* @__PURE__ */ jsx_dev_runtime5.jsxDEV("span", {
    ...
    children: [
      import_react4.isValidElement(target) ? import_react4.cloneElement(target, {
...
function ShareButtons({ title, slug }) {
  ...
  const [showFediverse, setShowFediverse] = import_react5.useState(false);
  const [instance, setInstance] = import_react5.useState("");
...
function useReadArticles() {
  const [readSlugs, setReadSlugs] = import_react7.useState(() => new Set);
  import_react7.useEffect(() => {
    setReadSlugs(loadReadSlugs());
  }, []);
  const markRead = import_react7.useCallback((slug) => {
    setReadSlugs((prev) => {
      if (prev.has(slug))
        return prev;
...
function WikiShow({ article, categories }) {
  ...
  const processed = import_react8.useMemo(() => preprocessMarkdown(article.content), [article.content]);
  const toc = import_react8.useMemo(() => extractToc(article.content), [article.content]);
...
//# debugId=214AE2860F907C5964756E2164756E21
//# sourceMappingURL=chunk-374qr7r6.js.map
