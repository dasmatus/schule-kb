...
> `pc7.docx` — [[pc7.docx|otvoriť originál]]
...
Modul [[Impedancia|impedancie]] (veľkosť impedancie) je potom:
...
4. Meranie fázového posunu φ medzi napätím a prúdom pomocou [[Osciloskop|osciloskopu]] – z časového posunu medzi nulovými prechodmi oboch signálov podľa vzťahu φ = (Δt / T) × 360°, kde Δt je časový posun a T je períoda signálu.
